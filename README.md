# Data Science & Analytics 6-Week Internship with DevelopersHub Corporation
...
1. **Data Cleaning & Preprocessing:** Handle categorical and numerical data, prepare it for analysis and machine learning.  
2. **Exploratory Data Analysis (EDA):** Understand distributions, relationships, and patterns in the data using visualizations.  
...
- **Feature Importance Analysis:** Identified which features impact loan repayment most    
